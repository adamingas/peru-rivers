...
$(error Install R before commencing.If you think this is in error, check that your PATH contains Rscript)
endif
#################################################################################
# COMMANDS                                                                      #
#################################################################################
...
## Converts raw data into usable otu-matrices and properly formatted metadata
data: 
	@mkdir -p "data/raw"
